...
class TestGeminiLLM(TestJudgeLLMBase):
    ...
    @patch("llm_clients.gemini_llm.Config.GOOGLE_API_KEY", "test-key")
    @patch("llm_clients.gemini_llm.ChatGoogleGenerativeAI")
    def test_init_with_kwargs(self, mock_chat_gemini, default_llm_kwargs):
    ...
    @patch("llm_clients.gemini_llm.Config.GOOGLE_API_KEY", "test-key")
    @patch("llm_clients.gemini_llm.ChatGoogleGenerativeAI")
    async def test_generate_structured_response_success(self, mock_chat_gemini):
        ...
        llm = GeminiLLM(name="TestGemini", role=Role.JUDGE, system_prompt="Test prompt")
    ...
    @patch("llm_clients.gemini_llm.Config.GOOGLE_API_KEY", "test-key")
    @patch("llm_clients.gemini_llm.ChatGoogleGenerativeAI")
    async def test_generate_structured_response_error(self, mock_chat_gemini):
    ...
    @patch("llm_clients.gemini_llm.Config.GOOGLE_API_KEY", "test-key")
    @patch("llm_clients.gemini_llm.ChatGoogleGenerativeAI")
    async def test_structured_response_metadata_fields(self, mock_chat_gemini):
